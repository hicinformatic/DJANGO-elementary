...
class AuthenticationLDAPForm(AuthenticationForm):
    ...
    username = UsernameField(label=T.ldap.login, max_length=254, widget=forms.TextInput(attrs={'autofocus': True}))
    error_messages = {'invalid_login': T.error.invalid_login, 'inactive': T.error.inactive}
